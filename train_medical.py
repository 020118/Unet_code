...
from dataloader_medical import UnetDataset, unet_dataset_collate
from utils import (download_weights, seed_everything, show_config,
                         worker_init_fn)
from utils_fit import fit_one_epoch_no_val
...
# train_medical.py相较于train.py，去掉了关于验证推理val的部分，其余不变
